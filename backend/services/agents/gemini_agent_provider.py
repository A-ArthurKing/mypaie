...
from services.regles_primes.dw_api_regles_provider import get_regle_by_id, create_regle_config, get_regle_configs
from services.parametres.mapping_provider import get_all_kpis_with_status
...
def get_real_performance_tool(regle_id: int, mois: str) -> str:
    ...
    """
    import statistics
    from services.performance.dw_api_performance_provider import get_perf_totaux_par_matricule
    from services.notes_qualite.dw_api_qualite_provider import get_qualite_totaux_par_matricule
    from services.heures_agents.dw_api_heures_provider import get_totaux_par_matricule
