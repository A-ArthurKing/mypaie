"""
Fichier : api/regles_primes/routes.py
Rôle    : Blueprint Flask exposant les endpoints REST pour les règles de primes.
Module  : mypaie / backend / api / regles_primes
"""

import logging
from flask import Blueprint, jsonify, request
from core.socket import emit_update
from services.regles_primes.provider import (
...
def endpoint_update_grilles_order(regle_id):
    try:
        from services.regles_primes.provider import update_grilles_order
        data = request.json
