"""
Fichier : api/agents/routes.py
Rôle    : Blueprint Flask — endpoints REST pour la gestion des agents.
Module  : mypaie / backend / api / agents
"""
...
from services.regles_primes.provider import get_regle_by_id
...
def endpoint_get_agents(regle_id):
    ...
    try:
        ...
        with mysql_conn.cursor() as cur:
            ...
            # 2. Récupérer les agents qui matchent cette branche de structure
            sql = """
                SELECT 
