"""
Fichier : api/notes_qualite/routes.py
Rôle    : Blueprint Flask exposant les endpoints REST pour les notes qualité.
Module  : mypaie / backend / api / notes_qualite
"""

import logging
from flask import Blueprint, jsonify, request
from services.notes_qualite.provider import (
    get_qualite_agents,
...
def endpoint_qualite_totaux():
    ...
    Paramètres query : date_debut, date_fin, matricules, agents_map (optionnel JSON)
    """
