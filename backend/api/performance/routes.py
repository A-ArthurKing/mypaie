"""
Fichier : api/performance/routes.py
Rôle    : Blueprint Flask exposant les endpoints REST pour les données de performance.
Module  : mypaie / backend / api / performance
"""

import logging
from flask import Blueprint, jsonify, request
from services.performance.provider import get_performance_pvcp, get_perf_totaux_par_matricule
...
def endpoint_performance_totaux():
    """
    Retourne la DMT agrégée par matricule.
